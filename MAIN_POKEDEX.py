...
#-------------------------------------------------------------------------------------------
        ...
        with open("pokemon.txt") as pk:
                ...
                canvas.create_text(460,200,text=leer,fill="black",font=("times",12,"bold"),tags="status",anchor=NW)
...
class Pokedex:
    ...
    def error():
        with open("pokemon0.txt") as pk:
                Variables.leer=pk.read().capitalize()
        canvas.create_text(460,200,text=Variables.leer,fill="black",font=("times",20,"bold"),tags="status",anchor=NW)
    ...
    def b0_click():#---------------------------------------------------------------boton editar pokemon de lista        
            ...
            buscaredit=Pokedex.entry1.get()
            nombre2=Pokedex.entry2.get()
    ...
    def b2_click():#--------------Boton Buscar Pokemon
        sonidoentrar=mixer.Sound("resources/pokeboton.mp3")
        sonidoentrar.play()
        buscar=Pokedex.entry1.get()
        
        Get_Pokemon.next(buscar)
        Pokedex.updateimg()    
